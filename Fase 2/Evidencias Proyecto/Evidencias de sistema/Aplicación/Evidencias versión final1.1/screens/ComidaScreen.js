...
const fetchComidaData = async () => {
  console.log("Fetching comida data...");
  try {
    ...
    // Filtrar los sacos con cantidad menor a 20
    ...
    // Actualizar datos y forzar re-render
    setComidaData(formattedData);
    setReload((prevReload) => !prevReload); // Alternar el estado para forzar el re-render
...
/>
      ...
      >
        <TouchableOpacity onPress={fetchComidaData}>
  <Text
    style={[
      styles.headerTitle,
